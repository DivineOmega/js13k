...
function AboutScene()
{
    ...
    this.renderFunction = function()
    {
        ...
        this.convergame.drawText(width / 2, (height / 2) + 64, colWhite, 32, textFont, "center", "Jordan Hall", true, 0, 2, "#c0392b");
        this.convergame.drawText(width / 2, (height / 2) + 128, colWhite, 32, textFont, "center", "Ollie Reardon", true, 0, 2, "#c0392b");
