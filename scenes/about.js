...
function AboutScene()
{
    ...
    this.renderFunction = function()
    {
        ...
        this.convergame.drawText(width / 2, height / 2, white, 64, font, "center", "Credits", false, 0, 2, "#c0392b");
        this.convergame.drawText(width / 2, (height / 2) + 64, white, 32, font, "center", "Jordan Hall", false, 0, 2, "#c0392b");
        this.convergame.drawText(width / 2, (height / 2) + 128, white, 32, font, "center", "Ollie Reardon", false, 0, 2, "#c0392b");
