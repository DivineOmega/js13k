...
function MinigameCol()
{
    ...
    { 
        ...
        this.convergame.drawText( width / 4 , height / 2, white, 40, font, "left", this.leftChoice[1].toLowerCase(), false, 0, 2, "#2c3e50");
        this.convergame.drawText((width / 2) + (width / 4), height / 2, white, 40, font, "right", this.rightChoice[1].toLowerCase(), false, 0, 2, "#2c3e50");
